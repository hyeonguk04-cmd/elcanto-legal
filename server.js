...
2. **📜 법적 근거** (반드시 포함)
   - 관련 법령: [법령명 제○조 제○항] 
   - 회계기준: [K-IFRS 제○호, 문단○]
   - 세법 조항: [법인세법 제○조, 시행령 제○조]
   - 예규/유권해석: [국세청 예규 번호, 날짜]
   예시: "법인세법 제18조 제1항에 따르면..."

3. **💼 실무 적용** (구체적 계산 예시 포함)

4. **⚠️ 주의사항** (함정, 예외사항, 벌칙 규정)

5. **🔗 참고 자료** (법령, 기준서, 공식 사이트 링크)

**중요:** 법적 근거는 반드시 "[법령명] 제○조 제○항" 형식으로 명시하고, 조문 내용을 인용하세요.`,
...
2. **📜 법적 근거** (반드시 포함)
   - 관세법: [관세법 제○조 제○항]
   - FTA 협정: [한-○○ FTA 제○장 제○조]
   - 대외무역법: [대외무역법 제○조]
   - HS Code: [HS Code ○○○○.○○]
   예시: "관세법 제241조 제1항에 따르면..."

3. **💼 실무 절차** (신고 방법, 서류, 유니패스 처리)

4. **⚠️ 주의사항** (처벌 규정, 과태료, 통관 거부 사유)

5. **🔗 참고 자료** (관세법령, FTA 협정문 링크)

**중요:** 관세법 조항과 HS Code를 반드시 명시하고, 처벌 규정(벌금, 징역)도 함께 안내하세요.`,
...
2. **📜 법적 근거** (반드시 포함)
   ...
   - 판례: [대법원 ○○○○도○○○○ 판결]
   - 행정해석: [고용노동부 유권해석 ○○○○-○○○○]
   예시: "근로기준법 제60조에 따르면 연차유가휴가는..."

3. **💼 계산 방법** (수당, 휴가, 4대보험 구체적 계산식)

4. **⚠️ 주의사항** (벌칙 - 형법 조항, 과태료, 노동분쟁 발생 시 대응)

5. **🔗 참고 자료** (근로기준법령, 고용노동부 지침 링크)

**중요:** 근로기준법 조항(제○조)과 벌칙(3년 이하 징역, ○○만원 이하 벌금)을 반드시 명시하세요.`,
...
2. **📜 법적 근거** (반드시 포함)
   - 민법: [민법 제○조 제○항] 
   - 상법: [상법 제○조]
   - 공정거래법: [독점규제 및 공정거래에 관한 법률 제○조]
   - 판례: [대법원 ○○○○다○○○○ 판결 (날짜)]
   예시: "민법 제543조(채무불이행으로 인한 해제)에 따르면..."

3. **⚖️ 판례 분석** (유사 판례와 법원 판단 요지)

4. **📝 계약서 작성 팁** (필수 조항, 리스크 회피 문구)

5. **🔗 참고 자료** (법령, 판례 전문 링크)

**중요:** 민법·상법 조항(제○조)과 대법원 판례(사건번호, 판결 날짜)를 반드시 명시하세요.`,
...
2. **📜 법적 근거** (반드시 포함)
   - 소비자기본법: [소비자기본법 제○조 제○항]
   - 전자상거래법: [전자상거래 등에서의 소비자보호에 관한 법률 제○조]
   - 표시광고법: [표시·광고의 공정화에 관한 법률 제○조]
   - 분쟁조정 기준: [소비자분쟁해결기준 고시 제○조]
   예시: "전자상거래법 제17조(청약철회)에 따르면 7일 이내..."

3. **📋 대응 매뉴얼** (단계별 절차, 법정 기한)

4. **💬 예시 답변** (고객 응대 스크립트, 법적 근거 포함)

5. **🔗 참고 자료** (소비자보호법령, 분쟁조정 기준 링크)

**중요:** 청약철회 기한(7일), 환불 기한(3영업일) 등 법정 기한과 조항을 반드시 명시하세요.`,
...
app.post('/api/search', authMiddleware, async (req, res) => {
  try {
    ...
    try {
      // Gemini 3.1 Flash (최신 데이터 - 2026년 2월)
      console.log('📤 Gemini 3.1 Flash 초기화 (최신 모델)...');
      ...
      console.log('✅ 모델 초기화 완료 (gemini-3.1-flash)');
